 ...
 * @author qntmt
 */
public class ATreat extends javax.swing.JFrame {
...
try{
    ...
    String query = "INSERT INTO Treatments(Treatment, CostINR, InstrumentsRequired, MaterialsRequired) " + "VALUES(\""+a+"\",\""+b+"\",\""+c+"\",\""+d+"\")"+";" ;
