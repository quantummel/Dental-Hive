 ...
 * @author qntmt
 */
public class AApp extends javax.swing.JFrame {
...
try{
    ...
    String query = "INSERT INTO Appointments(DateTime, DoctorID, PatientID, AssistantID, TreatmentID) " + "VALUES(\""+a+"\",\""+b+"\",\""+c+"\",\""+d+"\",\""+e+"\")"+";" ;
