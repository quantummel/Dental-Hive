 ...
 * @author qntmt
 */
public class UPat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pointttttt.setText("Medical History:");
...
if (pointt.isSelected())
{
 String a = namedd.getText();
    query = "update Patients set Name=\""+a+"\" where PatientID="+id+";";
}
else if (pointtt.isSelected())
{
 String a = nameddd.getText();
    query = "update Patients set PhoneNumber=\""+a+"\" where PatientID="+id+";";
}
else if (pointttt.isSelected())
{
 String a = namedddd.getText();
    query = "update Patients set Address=\""+a+"\" where PatientID="+id+";";
}
else if (pointtttt.isSelected())
{
 String a = nameddddd.getText();
    query = "update Patients set DOB=\""+a+"\" where PatientID="+id+";";
}
else if (pointttttt.isSelected())
{
 String a = namedddddd.getText();
    query = "update Patients set MedicalHistory=\""+a+"\" where PatientID="+id+"; ";
}       
try{
